...
from database import get_db, UserProfileModel, UserGroupModel, UserModel, UserGroupEnum
...
async def create_profile(
    ...
    data: ProfileCreateRequestSchema = Depends(ProfileCreateRequestSchema.from_form),
